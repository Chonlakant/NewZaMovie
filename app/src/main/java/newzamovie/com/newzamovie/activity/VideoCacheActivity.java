...
import newzamovie.com.newzamovie.video.DensityUtil;
import newzamovie.com.newzamovie.video.FullScreenVideoView;
import newzamovie.com.newzamovie.video.LightnessController;
import newzamovie.com.newzamovie.video.VolumnController;
...
public class VideoCacheActivity extends Activity implements CacheListener,View.OnClickListener {
    ...
    private ImageView mPlay,minimize;
    ...
    private void setUpUi() {
        ...
        VIDEO_CACHE_NAME = "https://9player.net/tube/stream.php?q=@TAV@KKP@TSP@TAV@VBD&s=9nung";
        VIDEO_URL = "https://9player.net/tube/stream.php?q=@TAV@KKP@TSP@TAV@VBD&s=9nung";
        ...
        minimize = (ImageView)findViewById(R.id.btn_expandc);
        ...
        playTime = getIntent().getIntExtra("start",0);
        //playVideo();
...
//                if (playTime != 0) {
//                    Toast.makeText(VideoCacheActivity.this, playTime, Toast.LENGTH_SHORT).show();
...
//        i.putExtra("start",mVideo.getCurrentPosition());
//        i.putExtra("vid",VID);
//        startActivity(i);
//    }
}
