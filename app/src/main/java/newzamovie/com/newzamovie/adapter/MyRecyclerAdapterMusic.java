...
public class MyRecyclerAdapterMusic extends RecyclerView.Adapter<MyRecyclerAdapterMusic.ContactViewHolder> {

    private ArrayList<Music> contactList = new ArrayList<>();
    Context context;
    ...
    public MyRecyclerAdapterMusic(Context context, ArrayList<Music> contactList) {
    ...
    public void onBindViewHolder(ContactViewHolder contactViewHolder, int i) {
       // listMain ci = contactList.get(i);
        Music item =  contactList.get(i);

        contactViewHolder.movie_name.setText(item.getLoadpleng().get(i).getTitle());

        Picasso.with(context)
                .load(item.getLoadpleng().get(i).getUrlcover())
                .fit().centerCrop()
