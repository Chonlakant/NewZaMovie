...
public class MyRecyclerAdapterCartoon extends RecyclerView.Adapter<MyRecyclerAdapterCartoon.ContactViewHolder> {

    private ArrayList<Cartoon> contactList = new ArrayList<>();
    Context context;
    ...
    public MyRecyclerAdapterCartoon(Context context, ArrayList<Cartoon> contactList) {
    ...
    public void onBindViewHolder(ContactViewHolder contactViewHolder, int i) {
       // listMain ci = contactList.get(i);
        Cartoon item =  contactList.get(i);

        contactViewHolder.movie_name.setText(item.getCartoon().get(i).getTitle());

        Picasso.with(context)
                .load(item.getCartoon().get(i).getUrlcover())
                .fit().centerCrop()
